...
import com.example.thespa.view.bookAppointment.schedule.ScheduleActivity;
        ...
        invite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (permissionGranted) {
                    ...
                    Toast.makeText(context, getBaseContext().getString(R.string.contact_permission), Toast.LENGTH_SHORT).show();
            }
        });
        add_to_list.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(isUnique(phone_text.getText().toString())) {
                    contactsChoosenAdapter.addItem(phone_text.getText().toString());
                    phones.add(phone_text.getText().toString());
                    phone_text.setText("");

                }
                else
                {
                    Toast.makeText(context, getBaseContext().getString(R.string.phone_added), Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.READ_CONTACTS)
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                if (shouldShowRequestPermissionRationale(Manifest.permission.READ_CONTACTS)) {
                    Toast.makeText(this, getBaseContext().getString(R.string.permission_contacts), Toast.LENGTH_LONG).show();
                } else {
