...
import com.example.thespa.bookAppointment.services.BookServicesActivity;
...
public class BookSpecialities extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        beautician = new Beautician("Yara");
        beautician1 =  new Beautician("Yara");
        beautician2 =  new Beautician("Yara");
