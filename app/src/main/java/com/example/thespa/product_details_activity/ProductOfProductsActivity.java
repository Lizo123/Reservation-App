...
public class ProductOfProductsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        product = new Brush("Brushes","ssssssfsrfsfffffffffffffffffffff");
        product1 =  new Brush("Lips","ssssssfsrfsfffffffffffffffffffff");
        product2 =  new Brush("Eyes","ssssssfsrfsfffffffffffffffffffff");
